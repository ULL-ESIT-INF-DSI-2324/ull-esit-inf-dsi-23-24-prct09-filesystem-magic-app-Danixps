...
describe('Comandos de la aplicación', () => {
    it('Comando add con una carta nueva', () => {
        execSync('node ../ull-esit-inf-dsi-23-24-prct09-filesystem-magic-app-Danixps/dist/index.js add --user "danixps" --id 777 --name "Black Lotus" --manaCost 69 --color "multicolor" --type "criatura" --rarity rara --rulesText "Tap to add three mana of any color to your mana pool." --marketValue 1234 --powerandtoughness 5 11');
